...
def runtime_architecture() -> None:
    ...
    agents = box(draw, (90, 930, 720, 1105), "Deterministic decision council", "Specialists, Bull/Bear cases and RiskCouncil produce auditable votes; hard blocks win", AMBER)
    ...
    ollama = box(draw, (1680, 930, 2310, 1105), "TradingAgents + Ollama research", "Offline specialists, debate, RAG and expiring advisory. No broker access.", VIOLET)
    ...
    box(draw, agents, "Deterministic decision council", "Specialists, Bull/Bear cases and RiskCouncil produce auditable votes; hard blocks win", AMBER)
    ...
    box(draw, ollama, "TradingAgents + Ollama research", "Offline specialists, debate, RAG and expiring advisory. No broker access.", VIOLET)
...
def decision_flow() -> None:
    ...
    features = box(draw, (730, 585, 1670, 735), "Features and decision council", "Causal inputs, specialist votes, Bull/Bear evidence, RiskCouncil and fresh bounded advisory", GREEN)
    ...
    box(draw, features, "Features and decision council", "Causal inputs, specialist votes, Bull/Bear evidence, RiskCouncil and fresh bounded advisory", GREEN)
