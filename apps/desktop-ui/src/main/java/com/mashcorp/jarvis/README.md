...
| `DecisionRadar` | Paints six measured or gate-backed axes as a clipped, non-interactive 20-100 radar with fixed edge callouts and per-axis color coding. It never invents a missing model probability or writes application state. |
