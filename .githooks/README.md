...
| File | Responsibility |
|---|---|
| [`post-checkout`](../.githooks/post-checkout) | Version-controlled project resource. |
| [`post-commit`](../.githooks/post-commit) | Version-controlled project resource. |
| [`post-merge`](../.githooks/post-merge) | Version-controlled project resource. |
| [`pre-commit`](../.githooks/pre-commit) | Version-controlled project resource. |
| [`pre-push`](../.githooks/pre-push) | Version-controlled project resource. |
