...
class Settings:
    ...
    promotion_max_calibration_error: float = 0.10
...
def load_settings(env_file: str | Path | None = None) -> Settings:
    ...
    settings = Settings(
        ...
        promotion_min_trade_count=_int_env("PROMOTION_MIN_TRADE_COUNT", 200),
        promotion_min_profitable_fold_ratio=_float_env("PROMOTION_MIN_PROFITABLE_FOLD_RATIO", 0.60),
        promotion_max_calibration_error=_float_env("PROMOTION_MAX_CALIBRATION_ERROR", 0.10),
